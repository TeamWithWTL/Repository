package com.jcwx.action.websocket;
...
public class WebSocketTest {
	...
	public void onOpen(@PathParam("myWebsocket") String myWebsocket,Session session){
		List<SysMenu> a = loginService.findMenusByPid(null);
	...
	public void onClose(@PathParam("myWebsocket") String myWebsocket){
		...
		System.out.println(myWebsocket+"关闭！当前在线人数为" + getOnlineCount());
	}
	...
	public void onMessage(@PathParam("myWebsocket") String myWebsocket,String message, Session session) {
		System.out.println(myWebsocket+"的消息:" + message);
		//群发消息
