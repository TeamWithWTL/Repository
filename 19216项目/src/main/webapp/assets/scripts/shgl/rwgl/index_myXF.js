...
function initData(pageNumber){
	...
	$("#table-container").load(basePath + "/shgl/rwgl/myXF.do",{'ajaxCmd': 'table', 'pageNumber': pageNumber, 'title': $("#title").val()}, function(){
...
function goView(taskId){
	...
	top.layer.open({
	    ...
	    fix: false,
	    area: ['80%', '80%'],
	    content: basePath + '/shgl/rwgl/myXFXq.do?taskId='+taskId,
	    end:function(){
	    	initData(1);
		  }
	  });
